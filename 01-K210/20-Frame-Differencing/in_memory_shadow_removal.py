...
#
# This example demonstrates using frame differencing with your CanMV Cam using
...
while(True):
    ...
    print(clock.fps(), triggered) # Note: Your CanMV Cam runs about half as fast while
